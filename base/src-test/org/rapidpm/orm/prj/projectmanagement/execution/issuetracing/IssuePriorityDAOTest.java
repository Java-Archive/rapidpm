...
public class IssuePriorityDAOTest extends BaseDAOTest {
    ...
    public void testDringendUWichtig() throws Exception {
        final org.rapidpm.orm.prj.projectmanagement.execution.issuetracking.IssuePriority issuePriority = daoFactoryFactory.getIssuePriorityDAO().loadPriorityDringend_u_Wichtig();
