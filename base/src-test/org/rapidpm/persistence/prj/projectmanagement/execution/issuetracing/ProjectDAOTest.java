...
public class ProjectDAOTest extends BaseDAOTest {
    ...
    public void testSaveProject() throws Exception {
        ...
        final Benutzer benutzer = daoFactory.getBenutzerDAO().loadBenutzer("sven.ruppert", "RapidPMPortal");
    ...
    public void testDeleteProject() throws Exception {
        ...
        final EntityTransaction transaction = entityManager.getTransaction();
        transaction.begin();
        final List<PlannedProject> projects = daoFactory.getProjectDAO().loadProjectsFor("RapidPMPortal");
