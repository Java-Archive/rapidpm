...
public class IssueBaseDAOTest extends BaseDAOTest {
    ...
    public void testLoadAllIssuesFor001() throws Exception {
        ...
        final List<IssueBase> issueBases = issueBaseDAO.loadAllIssuesFromVersionToVersion("RapidPMPortal", "RapidPM - intern - allgemeines", "sven.ruppert", "open", version, null, null);
    ...
    public void testLoadAllIssuesFor002() throws Exception {
        final IssueBaseDAO issueBaseDAO = daoFactory.getIssueBaseDAO();
        final Date version = Date.valueOf("2010-11-26");
        final List<IssueBase> issueBases = issueBaseDAO.loadAllIssuesFromVersionToVersion("RapidPMPortal", "RapidPM - intern - allgemeines", "sven.ruppert", "open", null, null, null);
        assertNotNull(issueBases);
    }
    ...
    public void testLoadAllIssuesFor003() throws Exception {
        ...
        final List<IssueBase> issueBases = issueBaseDAO.loadAllIssuesFromVersionToVersion("RapidPMPortal", "RapidPM - intern - allgemeines", "sven.ruppert", "open", dateTime.toDate(), null, null);
        assertNotNull(issueBases);
    }
    ...
    public void testLoadAllIssuesFromVersionToVersion() throws Exception {
        final IssueBaseDAO issueBaseDAO = daoFactory.getIssueBaseDAO();
        List<IssueBase> issueBases = issueBaseDAO.loadAllIssuesFromVersionToVersion("RapidPMPortal", "RapidPM - intern - allgemeines", "sven.ruppert", "open", null, null, null);
        assertNotNull(issueBases);
        issueBases = issueBaseDAO.loadAllIssuesFromVersionToVersion("RapidPMPortal", "RapidPM - intern - allgemeines", "sven.ruppert", "open", new DateTime("2010-11-23").toDate(), new DateTime("2010-12-03").toDate(), null);
        assertNotNull(issueBases);
    }
