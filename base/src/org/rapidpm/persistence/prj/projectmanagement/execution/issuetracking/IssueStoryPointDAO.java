...
public class IssueStoryPointDAO extends GraphBaseDAO<IssueStoryPoint> {
    ...
    public List<IssueBase> getConnectedIssuesFromProject(final IssueStoryPoint status, final Long projectId) {
        if (status == null)
        ...
        final RelationshipType relType = GraphRelationRegistry.getRelationshipTypeForClass(IssueStoryPoint.class);
