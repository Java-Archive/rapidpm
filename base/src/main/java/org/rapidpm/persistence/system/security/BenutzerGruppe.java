...
public class BenutzerGruppe {
  ...
  @GeneratedValue(strategy = GenerationType.TABLE, generator = "PKGenBenutzerGruppe") private Long id;
  ...
  @Column(unique = true) @Basic @NotNull private String gruppenname;
