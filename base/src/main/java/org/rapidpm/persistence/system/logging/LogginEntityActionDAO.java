...
//        return orientDB.createQuery("from LoggingEntityAction lea where lea.action='deleted'", LoggingEntityAction.class).getSingleResult();
    ...
    @Override
    public LoggingEntityAction loadFull(LoggingEntityAction entity) throws InvalidKeyException, NotYetImplementedException {
        throw new NotYetImplementedException();
    }

    @Override
    public LoggingEntityAction createEntityFull(LoggingEntityAction entity) throws InvalidKeyException, NotYetImplementedException, MissingNonOptionalPropertyException {
        throw new NotYetImplementedException();
    }
}