...
public class Benutzer
  ...
  @Id
  @TableGenerator(name = "PKGenBenutzer", table = "pk_gen", pkColumnName = "gen_key", pkColumnValue = "Benutzer_id", valueColumnName = "gen_value", allocationSize = 1)
  @GeneratedValue(strategy = GenerationType.TABLE, generator = "PKGenBenutzer") private Long id;


  @Basic private Boolean hidden;

  @Basic @NotNull @Size(min = 3) private String login;

  @Basic  //TODO unique Constrain fehlt evtl pro Mandant
  private String email;


  @Basic @NotNull //@Size(min = 8)
  private        String  passwd;
  @Basic private Date    lastLogin;
  @Basic private Integer failedLogins;
  ...
  @ManyToOne(cascade = {
      CascadeType.REFRESH
  }, optional = false, fetch = FetchType.EAGER) private Mandantengruppe mandantengruppe;

  // TODO entfernen?
  @ManyToOne(cascade = {
      CascadeType.REFRESH
  }, optional = false, fetch = FetchType.EAGER) private BenutzerGruppe benutzerGruppe;

  @ManyToOne(cascade = {
      CascadeType.REFRESH
  }, optional = false, fetch = FetchType.EAGER) private BenutzerWebapplikation benutzerWebapplikation;

  @ManyToMany(cascade = CascadeType.REFRESH, fetch = FetchType.EAGER) private Set<Rolle> rollen;
  ...
  public boolean equals(Object o) {
    ...
    if (id != null
        ? !id.equals(benutzer.id)
        : benutzer.id != null) return false;
