...
public class BenutzerGruppeDAO
    extends DAO<Long, BenutzerGruppe> {
  ...
  public BenutzerGruppe loadBenutzerGruppeByName(final String benutzerGruppenName) {
    final TypedQuery<BenutzerGruppe> typedQuery = entityManager.createQuery(
        "from BenutzerGruppe bg where bg.gruppenname=:benutzerGruppenName", BenutzerGruppe.class)
                                                               .setParameter("benutzerGruppenName",
                                                                             benutzerGruppenName);
