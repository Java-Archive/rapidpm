...
public class OntologieDAO extends DAO<Long, Ontologie> {
    ...
    public OntologieDAO(final OrientGraph orientDB) {
        super(orientDB, Ontologie.class);
    }
    ...
    public List<Ontologie> loadAllForMandantengrupe(final Mandantengruppe mandantengruppe) {
        ...
        //        final ObjectSet<Ontologie> ontologieListe = orientDB.query(new Predicate<Ontologie>() {
        //            @Override
...
//        return orientDB.createQuery("from Ontologie  o where o.mandantengruppe.mandantengruppe=:mandantengruppe", Ontologie.class).setParameter(
//                "mandantengruppe",
...
//                typedQuery =
//                orientDB.createQuery("from Ontologie  o " + "where o.mandantengruppe.mandantengruppe=:mandantengruppe " + "and o.symbolischerName=:symbolicName",
...
//        return getSingleResultOrNull(typedQuery);
        ...
        //        final ObjectSet<Ontologie> ontologies = orientDB.query(new Predicate<Ontologie>() {
        //            @Override
        //            public boolean match(final Ontologie ontologie) {
        //                final Mandantengruppe mgrp = ontologie.getMandantengruppe();
        //                if (mgrp.getMandantengruppe().equals(mandantengruppe)) {
