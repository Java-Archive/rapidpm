...
//                .setParameter("ontologie", ontologie).setParameter("value", value).setParameter("mandantengruppe", mandantengruppe).getResultList();
    ...
    @Override
    public OntologieEntry createEntityFull(OntologieEntry entity) throws InvalidKeyException, NotYetImplementedException, MissingNonOptionalPropertyException {
        throw new NotYetImplementedException();
    }
}
