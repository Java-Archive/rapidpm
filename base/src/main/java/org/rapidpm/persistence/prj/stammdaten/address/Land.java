...
//@NamedQueries({
//        @NamedQuery(name = "LoadLandForIsoCode", query = "select l from Land l where l.isoCode=:isoCode")
//})
...
public class Land {
    ...
    @TableGenerator(name = "PKGenLand",
            ...
            pkColumnValue = "Land_id",
            valueColumnName = "gen_value",
            allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "PKGenLand")
    private Long id;
    ...
    public boolean equals(final Object o) {
        ...
        if (getId() != null ? !getId().equals(land.getId()) : land.getId() != null) {
            return false;
        }
