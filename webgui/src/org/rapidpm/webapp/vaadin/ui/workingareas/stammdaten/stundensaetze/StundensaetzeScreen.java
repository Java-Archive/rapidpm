...
import org.rapidpm.webapp.vaadin.ui.workingareas.stammdaten.stundensaetze.logic.tasks.DeleteRowClickListener;
import org.rapidpm.webapp.vaadin.ui.workingareas.stammdaten.stundensaetze.components.ButtonComponent;
import org.rapidpm.webapp.vaadin.ui.workingareas.stammdaten.stundensaetze.components.EditOptionButtonGroup;
...
public class StundensaetzeScreen extends Screen {
    ...
    public StundensaetzeScreen(MainRoot root) {
        ...
        delRowButton.addListener(new DeleteRowClickListener(root, this, delRowButton));
