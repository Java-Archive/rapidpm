...
public class TreeSortDropHandler {
...
//        final ConfirmDialog confirmDialog = new ConfirmDialog(VaadinSession.getCurrent().getAttribute(ResourceBundle.class).getString
